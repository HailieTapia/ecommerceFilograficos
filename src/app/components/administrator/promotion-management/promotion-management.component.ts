...
export class PromotionManagementComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    this.promotionForm = this.fb.group({
      ...
      discount_value: ['', [Validators.min(0)]],
      max_uses: [null],
    ...
    this.promotionForm.get('restrict_to_cluster')?.valueChanges.subscribe(value => {
      this.applyUserSegmentation = value;
      this.toggleUserSegmentation();
    });
  }
  ngOnInit() {
    this.loadClusters();
      ...
      this.subscriptions.add(
        this.promotionService.getPromotionById(promotion.promotion_id).subscribe({
          next: (response) => {
            ...
            this.applyUserSegmentation = promo.restrict_to_cluster;
            ...
            this.promotionForm.patchValue({
              ...
              restrict_to_cluster: promo.restrict_to_cluster
            });
  ...
  savePromotion() {
    ...
    const promotionData: PromotionData = {
      ...
      restrict_to_cluster: this.applyUserSegmentation,
